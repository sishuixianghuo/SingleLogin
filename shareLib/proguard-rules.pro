...
# in /Users/caoruixiang/Develop/android/android-sdk-macosx/tools/proguard/proguard-android.txt
...
## 项目代码处理 start ##
-keep class com.bangbang.repository.data.** {*;}
## 项目代码处理 end ##
...
-keep class www.leg.com.sharelib.** {*;}
